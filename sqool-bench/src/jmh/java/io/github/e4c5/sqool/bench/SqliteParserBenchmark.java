...
/** JMH benchmarks for the SQLite parser. Provides baseline metrics for the v1 subset. */
@BenchmarkMode(Mode.Throughput)
@OutputTimeUnit(TimeUnit.MILLISECONDS)
@State(Scope.Benchmark)
public class SqliteParserBenchmark {

  private final SqliteSqlParser parser = new SqliteSqlParser();
  private final ParseOptions options = ParseOptions.defaults(SqlDialect.SQLITE);
